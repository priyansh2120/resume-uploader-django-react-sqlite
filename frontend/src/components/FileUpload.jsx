...
const FileUpload = ({onClose}) => {
  ...
  }, [submitSuccess, navigate, submitError, onClose]);
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-white rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-700">Resume File (Max 1 MB, .doc, .docx)<span className='text-red-700'>*</span></label>
          <input
            type="file"
            name="resumeFile"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Picture File (Max 100 KB, .jpg)<span className='text-red-700'>*</span></label>
          <input
            type="file"
            name="pictureFile"
            onChange={handleFileChange}
        ...
        <div>
            <label className="block text-sm font-medium text-gray-700">Country<span className='text-red-700'>*</span></label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">State<span className='text-red-700'>*</span></label>
            <select
              value={selectedState}
              onChange={(e) => {
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">City<span className='text-red-700'>*</span></label>
            <select
              value={selectedCity}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">User ID<span className='text-red-700'>*</span></label>
            <input
              type="text"
              name="userId"
              placeholder="User ID"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Date of Birth<span className='text-red-700'>*</span></label>
            <input
              type="date"
              name="dateOfBirth"
              onChange={handleInputChange}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Total Experience(In years)<span className='text-red-700'>*</span></label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Expected Salary<span className='text-red-700'>*</span></label>
            <input
              type="number"
              name="expectedSalary"
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700">Brief Description<span className='text-red-700'>*</span></label>
          <ReactQuill
            theme="snow"
